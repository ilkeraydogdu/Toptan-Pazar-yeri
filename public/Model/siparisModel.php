...
class siparisModel {
    ...
    public function siparisOlustur($kullaniciId, $urunId, $adet, $gram, $note, $siparisNumarasi) {
        try {
            ...
            $stmt = $this->db->prepare("INSERT INTO siparisler (siparisNumarasi, kullanici_id, urun_id, adet, gram, note, tarih) VALUES (?, ?, ?, ?, ?, ?, NOW())");
            $stmt->execute([$siparisNumarasi, $kullaniciId, $urunId, $adet, $gram, $note]);
