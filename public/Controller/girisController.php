<?php
session_start();
require_once '../Model/girisModel.php'; // Model dosya yolunu tam olarak belirtin
      ...
      if (is_array($userOrStatus)) {
        ...
        if ($_SESSION['durum'] == "aktif") {
          if ($_SESSION['rol'] == 'admin') {
            ...
            header('Location: ../Views/urunler.php'); // Kullanıcı sayfasının yolu düzeltilmiştir
          } else {
        ...
        header('Location: ../Views/giris.php?durum=sifreHatali'); // Hata durumunda yönlendirme düzeltilmiştir
        exit;
      }
    }
...
// Controller'ı oluştur ve giriş işlemini başlat
