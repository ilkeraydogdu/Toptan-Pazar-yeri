...
if ($_SESSION['rol'] == 'admin'){
	...
	try {
		$sql = "SELECT COUNT(*) AS toplam_siparis FROM siparisler";
		$stmt = $db->query($sql);
	...
	$kullaniciController = new kullaniciController;
	$kullanicilar = $kullaniciController->siparisVerenKullanicilariListele();
				...
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							...
							<h2 class="mb-0">
								<span class="number-font1"><?php echo number_format($toplamSatisMiktari, 2, ",", "."); ?> gr</span>
							</h2>
						</div>
				...
				<div class="card-body">
					<div class="d-flex align-items-end justify-content-between">
						<div>
							...
							<h2 class="mb-0">
								<span class="number-font1"><?php echo $toplamSiparis['toplam_siparis']; ?> Adet</span>
							</h2>
						</div>
				...
				<div class="col-12 mb-3">
					<div class="e-panel card">
						<div class="card-header">
							<h3 class="card-title">En Son Siparişler</h3>
						</div>
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-body">
										<div class="table-responsive mt-4">											<?php 
										if (!empty($enSonSiparisler)) { 
											...
											<table class="table table-bordered border text-nowrap mb-0">
												<thead>
													<tr>
														...
														<th class="wd-20p text-center">Kullanıcı Adı</th>
												...
												<tbody>
													<?php foreach ($enSonSiparisler as $siparis) { ?>
														<tr>
															...
															<td class="text-center"><?php echo $siparis["son_tarih"]; ?></td>
															<td class="text-center"><?php echo $siparis["kullanici_adi"]; ?></td>
											...
											echo '<tr><td colspan="3"><div class="alert alert-info" role="alert">Sipariş Yok!</div></td></tr>';
										} ?>
									</div>
								</div>
							</div>
